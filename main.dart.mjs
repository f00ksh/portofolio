...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1257: (x0,x1,x2) => x0.call(x1,x2),
      _1258: (x0,x1,x2,x3,x4,x5) => x0.call(x1,x2,x3,x4,x5),
      _1259: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1260: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      _1261: x0 => x0.call(),
      _1262: (x0,x1) => x0.append(x1),
      _1263: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1263(f,arguments.length,x0) }),
      _1264: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1264(f,arguments.length,x0) }),
      _1266: (x0,x1,x2,x3,x4,x5,x6) => x0.call(x1,x2,x3,x4,x5,x6),
      _1285: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1286: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      _1289: x0 => x0.call(),
      _1290: Date.now,
      ...
      _1306: x0 => new FinalizationRegistry(x0),
      _1307: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1308: (x0,x1,x2) => x0.register(x1,x2),
      _1309: (x0,x1) => x0.unregister(x1),
      _1310: () => globalThis.WeakRef,
      _1312: () => globalThis.FinalizationRegistry,
      _1314: s => JSON.stringify(s),
      _1315: s => printToConsole(s),
      _1316: (o, p, r) => o.replaceAll(p, () => r),
      _1317: (o, p, r) => o.replace(p, () => r),
      ...
      _1402: (handle) => clearTimeout(handle),
      _1403: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1404: (handle) => clearInterval(handle),
      _1405: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1406: () => Date.now(),
      _1413: (x0,x1) => x0.createElement(x1),
      _1417: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1417(f,arguments.length,x0) }),
      _1418: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1419: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1425: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1426: (x0,x1) => globalThis.fetch(x0,x1),
      _1427: (x0,x1) => x0.get(x1),
      _1428: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1428(f,arguments.length,x0,x1,x2) }),
      _1429: (x0,x1) => x0.forEach(x1),
      _1430: x0 => x0.abort(),
      _1431: () => new AbortController(),
      _1432: x0 => x0.getReader(),
      _1433: x0 => x0.read(),
      _1434: x0 => x0.cancel(),
      _1447: (s, m) => {
        try {
      ...
      _1480: o => [o],
      _1481: (o0, o1) => [o0, o1],
      _1482: (o0, o1, o2) => [o0, o1, o2],
      _1483: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1498: x0 => x0.groups,
      _1499: x0 => x0.flags,
      _1500: x0 => x0.multiline,
      _1501: x0 => x0.ignoreCase,
      _1502: x0 => x0.unicode,
      _1503: x0 => x0.dotAll,
      _1504: (x0,x1) => x0.lastIndex = x1,
      _1505: (o, p) => p in o,
      _1506: (o, p) => o[p],
      _1509: x0 => x0.random(),
      _1512: () => globalThis.Math,
      _1513: Function.prototype.call.bind(Number.prototype.toString),
      _1514: Function.prototype.call.bind(BigInt.prototype.toString),
      _1515: Function.prototype.call.bind(Number.prototype.toString),
      _1516: (d, digits) => d.toFixed(digits),
      _2883: (x0,x1) => x0.src = x1,
      _2885: (x0,x1) => x0.type = x1,
      _2891: (x0,x1) => x0.defer = x1,
      _5959: x0 => x0.signal,
      _6033: () => globalThis.document,
      _6115: x0 => x0.body,
      _7798: x0 => x0.value,
      _7800: x0 => x0.done,
      _8502: x0 => x0.url,
      _8504: x0 => x0.status,
      _8506: x0 => x0.statusText,
      _8507: x0 => x0.headers,
      _8508: x0 => x0.body,
...
"2024",
"Animation with Lottie and Rive",
"Online Course",
"stretch",
"WORK",
"OverflowBoxFit.",
...
"SvgAssetLoader(",
"Shapes.",
"assets/svg/tech/dart.svg",
"assets/svg/tech/docker.svg",
"assets/svg/tech/figma.svg",
"assets/svg/tech/firebase.svg",
"assets/svg/tech/flutter.svg",
"assets/svg/tech/gcloud.svg",
"assets/svg/tech/git.svg",
"assets/svg/tech/github.svg",
"assets/svg/tech/graphQl.svg",
"assets/svg/tech/jirra.svg",
"assets/svg/tech/kotlin.svg",
"assets/svg/tech/linux.svg",
"assets/svg/tech/mysql.svg",
"assets/svg/tech/postgress.svg",
"assets/svg/tech/postman.svg",
"assets/svg/tech/rust.svg",
"assets/svg/tech/supabase.svg",
"assets/svg/tech/vscode.svg",
"rebalance",
